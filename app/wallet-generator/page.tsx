                ...
                { !addWallet && (
                  <>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 mx-5">
                      <Button size={"lg"} onClick={() => setAddWallet(true)}>Add Wallet</Button>
                      <Button size={"lg"} onClick={() => handleGenerateWallet()}>Generate Wallet</Button>
                    </div>
                  </>
                )}
                { addWallet && (
                  <>
                    <div className="flex flex-col gap-2">
                      <h1 className="tracking-normal text-4xl md:text-5xl font-black">
